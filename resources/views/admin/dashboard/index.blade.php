...
@section('content')
    <div class="page-content">
        ...
        <div class="widgets">
            <?php $icon = ['pages' => 'voyager-file-text', 'articles' => 'voyager-news', 'products' => 'voyager-images'] ?>
            @foreach(\App\PostType::all() as $element)
                <div class="panel widget center bgimage" style="background-image:url('/images/background-{{$element->name}}.png');">
                    <div class="dimmer"></div>
                    <div class="panel-content">
                        <i class={{ $icon[$element->name] }}></i>
                        <?php $count = \App\Post::where(['post_type_id' => $element->id])->count(); ?>
                        <h4>{{ $count . ' ' .  $element->name }}</h4>
                        <p>You have {{ $count . ' ' .  $element->name }} in your database. Click on button below to view all {{ lcfirst($element->name) }}.</p>
                        <a href="/admin/{{ $element->name }}" class="btn btn-primary">View All {{ $element->name }}</a>
                    </div>
                </div>
            @endforeach
        </div>
        ...
        <div style="padding:15px;">
            <?php $google_analytics_client_id = null ?>
