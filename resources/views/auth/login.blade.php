...
<head>
    ...
    <!--
    <link rel="stylesheet" href="//fonts.useso.com/css?family=Roboto:300,400,500,300italic">
    -->
...
<div id="title_section">
    ...
    <img class="logo-img" src="{!! asset('/images/logo-icon-light.png') !!}" alt="Logo Icon">
...
<div id="login_section">
    <div class="content">
        ...
        <form action="{{ route('login') }}" method="POST" id="login">
            ...
            <img class="btn-loading" src="{!! asset('images/logo-icon.png') !!}" alt="Voyager Loader">
